/*
  ...
  - Added the required column `kongConsumerName` to the `ApiKey` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "kongConsumerName" TEXT NOT NULL,
