    ...
    <Flex stack gap="l">
      <Flex stack>
        ...
        <Text>
          ...
          . Please note that only JWTs generated by the RS256 algorithm are supported. Don’t see your use-case
        ...
        <Text>
          Note: some IDPs recommend rotating your JWT public key from time to time, please update your public key here
          when your key is rotated.
        </Text>
        <Text>
