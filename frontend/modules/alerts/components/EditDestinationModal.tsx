...
function ModalContent<K extends DestinationType>({ closeModal, destination }: ModalProps<K>) {
  ...
  const formProps: FormProps<DestinationType> = { destination, closeModal };
...
function TelegramDestinationForm({ destination, closeModal }: FormProps<'TELEGRAM'>) {
  ...
  const updateDestinationMutation = useUpdateDestination(closeModal);
...
function WebhookDestinationForm({ destination, closeModal }: FormProps<'WEBHOOK'>) {
...
function EmailDestinationForm({ destination, closeModal }: FormProps<'EMAIL'>) {
