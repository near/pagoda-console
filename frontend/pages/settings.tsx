    ...
    return (
        <div className='pageContainer'>
            ...
            <div className='titleContainer'>
                <h1>User Settings</h1>
                <Button onClick={toggleEditMode} disabled={!user?.name || updateInProgress}>{!isEditing ? 'Edit' : 'Done'}</Button>
            </div>
            ...
            <div className='settingsContainer'>
                <div className='settingRow'>
                    ...
                    {isEditing && <Form onSubmit={toggleEditMode}>
                        <Form.Control value={displayName} disabled={updateInProgress} onChange={(e) => setDisplayName(e.target.value)} />
                    </Form>}
                </div>
                <div className='settingRow'>
