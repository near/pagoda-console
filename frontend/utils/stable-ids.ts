...
export const enum StableId {
  ...
  DEPLOYS_DEPLOY = 'DEPLOYS_DEPLOY',
  DEPLOYS_GITHUB_EMAIL_LINK = 'DEPLOYS_GITHUB_EMAIL_LINK',
  ...
  GALLERY_DEPLOY_TEMPLATE_MODAL_GITHUB_USERNAME_INPUT = 'GALLERY_DEPLOY_TEMPLATE_MODAL_GITHUB_USERNAME_INPUT',
